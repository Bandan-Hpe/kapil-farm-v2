        ...
        <div className="w-3/5">
          ...
          <div className="flex justify-around mt-8">
            <div className="flex flex-col items-center">
              ...
              <p className="text-black ">100% Clear Time</p>
            </div>
            <div className="flex flex-col items-center">
              <Image src={icon2} alt="icon1" />
              <p className="text-black ">Patta Passbook</p>
            </div>
            <div className="flex flex-col items-center">
              <Image src={icon3} alt="icon1" />
              <p className="text-black ">Encroachment-Free</p>
            </div>
            <div className="flex flex-col items-center">
              <Image src={icon4} alt="icon1" />
              <p className="text-black ">TS Rythu Bharosa</p>
            </div>
            <div className="flex flex-col items-center">
