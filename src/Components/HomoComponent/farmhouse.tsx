...
const Farmhouse = () => {
  return (
    <>
      <section
        className="relative bg-cover bg-center lg:h-screen flex items-center px-10 py-10 mt-10"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center w-full">
          ...
          <h1 className="text-5xl text-[#e3bb3d]">
            Kapil farms-one of its kind farmland investment
          </h1>
          <div className="w-full flex justify-evenly m-10">
